    ...
    <AppShell>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-4">
          {/* Emails Sent */}
          <div className="glass-card flex flex-col justify-between p-3.5 sm:p-4 rounded-xl border border-border relative overflow-hidden group hover:border-primary/40 transition-all">
            ...
            <div className="mt-3 sm:mt-4">
              <h3 className="text-xl sm:text-2xl font-black text-foreground tracking-tight">{todaySent}</h3>
          ...
          <div className="glass-card flex flex-col justify-between p-3.5 sm:p-4 rounded-xl border border-border relative overflow-hidden group hover:border-primary/40 transition-all">
            ...
            <div className="mt-3 sm:mt-4">
              <h3 className="text-xl sm:text-2xl font-black text-foreground tracking-tight">{queueHealth}%</h3>
          ...
          <div className="glass-card flex flex-col justify-between p-3.5 sm:p-4 rounded-xl border border-border relative overflow-hidden group hover:border-primary/40 transition-all">
            ...
            <div className="mt-3 sm:mt-4">
              <h3 className="text-xl sm:text-2xl font-black text-foreground tracking-tight">{activeCount} Accounts</h3>
          ...
          <div className="glass-card flex flex-col justify-between p-3.5 sm:p-4 rounded-xl border border-border relative overflow-hidden group hover:border-primary/40 transition-all">
            ...
            <div className="mt-3 sm:mt-4">
              <h3 className="text-xl sm:text-2xl font-black text-foreground tracking-tight">{bounceRate}%</h3>
              <div className="flex items-center gap-1.5 mt-1">
          ...
          {/* Total Opens */}
          <div className="glass-card flex flex-col justify-between p-3.5 sm:p-4 rounded-xl border border-border relative overflow-hidden group hover:border-primary/40 transition-all animate-in fade-in">
            <div className="flex justify-between items-start">
            ...
            <div className="mt-3 sm:mt-4">
              <h3 className="text-xl sm:text-2xl font-black text-foreground tracking-tight">{serverData?.stats.opens ?? 0}</h3>
          ...
          <div className="glass-card flex flex-col justify-between p-3.5 sm:p-4 rounded-xl border border-border relative overflow-hidden group hover:border-primary/40 transition-all animate-in fade-in">
            ...
            <div className="mt-3 sm:mt-4">
              <h3 className="text-xl sm:text-2xl font-black text-foreground tracking-tight">{serverData?.stats.clicks ?? 0}</h3>
