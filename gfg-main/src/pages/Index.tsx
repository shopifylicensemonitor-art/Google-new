  ...
  return (
    <AppShell>
      ...
      <Button
        ...
        className="fixed right-4 bottom-[calc(5.5rem+env(safe-area-inset-bottom,0px))] lg:bottom-6 h-11 w-11 rounded-full bg-secondary/90 text-secondary-foreground hover:bg-secondary shadow-lg backdrop-blur-sm z-[70]"
        onClick={scrollToTop}
      >
