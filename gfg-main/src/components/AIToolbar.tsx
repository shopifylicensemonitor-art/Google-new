...
export function AIToolbar({
  ...
  return (
    <>
      <div className="py-2 border-b border-border mb-3 space-y-2">
        ...
        <Button
          ...
          disabled={loading}
          className="text-xs h-9 sm:h-8 gap-1.5 justify-start sm:justify-center text-primary border-primary/30 hover:bg-primary/10"
        >
        ...
        <Button
          ...
          disabled={loading}
          className="text-xs h-9 sm:h-8 gap-1.5 justify-start sm:justify-center text-foreground hover:bg-muted"
        >
        ...
        >
          ...
          <span className="truncate">Spintax</span>
        </Button>
