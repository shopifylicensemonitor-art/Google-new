...
export function FastMailSend({
  ...
  return (
    <div id="main-input-section" className="space-y-4 sm:space-y-5 rounded-2xl border border-border/80 bg-card/60 backdrop-blur-md p-4 sm:p-6 shadow-xl relative overflow-hidden transition-all duration-300 hover:border-primary/20 hover:shadow-2xl">
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <h2 className="text-base sm:text-lg font-black tracking-tight text-foreground truncate">Direct Send Panel</h2>
            <p className="text-[9px] uppercase tracking-widest font-mono font-bold text-primary/80 truncate">Direct Outreach</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1 sm:gap-2 shrink-0">
          <Button 
            ...
            className="text-xs h-9 px-2.5 sm:px-3 text-muted-foreground hover:text-foreground hover:bg-muted/40 rounded-lg transition-all duration-200"
            aria-label="Upload list"
          >
            <Upload className="h-4 w-4 text-primary sm:mr-1.5" />
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                size="icon"
                className="h-9 w-9 rounded-lg hover:bg-muted/40 text-muted-foreground hover:text-foreground"
