...
const regex = /<div className="p-6 flex-1 flex flex-col gap-6">[\s\S]*?<\/div>\s*<\/div>\s*\{\/\* Metric: Total Contacts \*\/\}/m;

const replacement = `<div className="p-6 flex-1 flex flex-col gap-6 overflow-y-auto max-h-[400px]">
...
console.log('patched Dashboard.tsx feed');
